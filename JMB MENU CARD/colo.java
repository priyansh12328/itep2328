...
public class colo {
    ...
    static final int MAX_SELS = 300;
    static String[] selTitle = new String[MAX_SELS];
    static double[] selPrice = new double[MAX_SELS];
    static String[][] selExtras = new String[MAX_SELS][200]; // each selection can have up to 200 lines of extras
    static int[] selExtrasCount = new int[MAX_SELS];
    ...
    static final int[] VEG_IDS = {1,2,3,4,5,6};
    static final String[] VEG_NAMES = {
        "Thali 1 (Rs.310)",
        "Thali 2 (Rs.360)",
        "Thali 3 (Rs.410)",
        "Thali 4 (Rs.470)",
    ...
    static final double[] VEG_PRICE = {310,360,410,470,600,700};
    ...
    // Chinese & Continental
    static final String[] CHINESE_CONTI = {
        "Veg Manchurian",
        "Veg Noodles",
        "Veg Fried Rice",
    ...
    static final String[] HEAVY_SNACKS = {
        "Pav Bhaji",
        "Vada Sambar",
        "Paratha with Dahi",
        "Samosa",
    ...
    // Breakfast plans
    static final int[] BF_IDS = {1,2,3};
    static final String[] BF_NAMES = {"Plan A (Rs.200)","Plan B (Rs.230)","Plan C (Rs.250)"};
    static final double[] BF_PRICE = {200,230,250};
    static final int[] BF_HEAVY_COUNT = {0,1,2};
    ...
    static int parseIntSafe(String in) {
        try {
    ...
    static void addExtraToSel(int selIdx, String extra) {
    ...
    static int chooseFromArray(String header, String[] arr, boolean allowBack) {
        while (true) {
            System.out.println("\n---- " + header + " ----");
    ...
    static void handleVegetarianMenuFlow() {
    ...
    // ---------- Breakfast flow ----------
    static void handleBreakfastFlow() {
        // show plans with SOP
        System.out.println("\n========== BREAKFAST PLANS ==========");
    ...
    static int chooseNumberFrom(int min, int max) {
        while (true) {
            String ln = scanner.nextLine().trim();
            int n = parseIntSafe(ln);
    ...
    static void printInvoiceCard(double subtotal, double gst, double total) {
        int width = 86;
        String top = TL + repeat(HR, width) + TR;
        String bottom = BL + repeat(HR, width) + BR;
        System.out.println(BG_CARD + top + RESET);
    ...
    static void printCardLine(String content) {
        int width = 86;
        if (content == null) content = "";
        if (content.length() >= width) {
            System.out.println(BG_CARD + VL + content.substring(0, width) + VL + RESET);
        } else {
            System.out.println(BG_CARD + VL + padRight(content, width) + VL + RESET);
        }
    }
}