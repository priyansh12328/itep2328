...
/*
                ...
                if(thaliChoice ==1 ){
                    soupDrink = chooseSoupDrink(sc);
                    vegDish1  =  chooseVeg(sc,1);
                    vegDish2 = chooseVeg(sc,1);
                    dalDish = chooseDal(sc);
                    riceDish = chooseRice(sc);
                    sweetdish = choosesweet(sc);
                ...
                switch (bch) {
                    case 1: 
                    breakfastItem = "Poha + Jalebi + Tea/Coffee + Bread Item";
                    breakfastPrice = 200;
                    break;
                    case 2: 
                    breakfastItem = "Poha + Jalebi + Bread  item + Heavy Snacks + Tea/Coffee";
                    breakfastPrice = 230; 
                    break;
                    case 3: 
                    breakfastItem = " Poha + jalebi +  Bread Item + 2 - Heavy Snacks + Tea/Coffee"; 
                    breakfastPrice = 250;
                     break;
                }
                /*
...
else  if (mainChoice == 3) { // kitty
                kittyordered = true;
                System.out.println(WHITE + MAROON_BG + "\nKitty Party MENU:" + RESET);
                System.out.println(BLACK + PITCH_BG + "1. BreakFast  1 - Rs.250");
                System.out.println(BLACK + PITCH_BG + "2. Breakfast 2  - Rs.300");
                System.out.println(BLACK + PITCH_BG + "3. Breakfast 3  - Rs.350" +RESET);
                 int kittychoice = getIntInRange(sc, "Select  number (1-3): ", 1, 3);

                 switch (kittychoice) {
                        case 1:
                            kittyname  = "Plan 1"; 
                            kittybreakfastPrice = 250;
                            break;
                        case 2:
                            kittyname = "Plan 2"; 
                            kittybreakfastPrice = 300;
                            break;
                        case 3:
                            kittyname = "Plan 3";
                            kittybreakfastPrice = 350;
                            break;
                 }


                 //show kitty party meneu 
                 showkittyitems(kittyname);
                  System.out.print(YELLOW + PITCH_BG + "Do you want to confirm this kitty party plan ? (1 = Yes, 0 = No): " + RESET);
                int confirm = getIntInRange(sc, "", 0, 1);
                if (confirm == 0) {
                    System.out.println(RED + "Selection cancelled. Returning to menu." + RESET);
                    kittyordered = false;
...
/* String kittyname = "" ;
        ...
        boolean  kittyordered = false ;*/
if ( kittybreakfastQty> 25) {
   kittyfreeBreakfastItems = 1;

} else if (kittybreakfastQty> 100) {
    kittyfreeBreakfastItems = 2; // 2 thali free  
  //  discount = 0.10;             // 10% discount
}
 int paidkittyqty = kittybreakfastQty - kittyfreeBreakfastItems;
         if (paidkittyqty < 0) paidkittyqty = 0;

double totalAmount = paidkittyqty * kittybreakfastPrice;
...
if(kittychoice == 1){ 
    ...
    starterDish = chooseStarter(sc);
    sweetdish =  choosesweet(sc);
    coffeechai = choosecoffeechai(sc);
...
subtotal += kittybreakfastPrice * paidkittyqty;
}  else {
                ordering = false;
            }
        }
        ...
        if (thaliOrdered) gstRate = 0.18;
         if (breakfastOrdered) gstRate = 0.18;
       else if (kittyordered) gstRate = 0.18;
       ...
       // System.out.println(WHITE_BG + BLACK);
        ...
        if (breakfastOrdered) {
         ...
         if (kittyordered) {
            if (!kittyname.isEmpty())
                System.out.printf("| %-38s %-5d %-5d %-10.2f|\n", kittyname, kittybreakfastPrice, kittybreakfastQty - kittyfreeBreakfastItems, (double) kittybreakfastPrice * (kittybreakfastQty - kittyfreeBreakfastItems));
            if (kittyfreeBreakfastItems > 0)
                System.out.printf("| %-38s %-5s %-5d %-10s|\n", "FREE Breakfast Items", "-", kittyfreeBreakfastItems, "FREE");
                  if (!soupDrink.isEmpty()) System.out.printf("|  Soup/Drink: %-49s|\n", soupDrink);
                  if (!snack.isEmpty()) System.out.printf("|  Snack: %-54s|\n", snack);
                  if (!sweetdish.isEmpty()) System.out.printf("|  Sweet dish: %-54s|\n", sweetdish);
                  if (!coffeechai.isEmpty()) System.out.printf("|  Coffee chai : %-54s|\n", coffeechai);
...
public static void showkittyitems(String kittyname){
    System.out.print(GREEN + WHITE_BG + "\nItems Included in " + kittyname + ":" +RESET);
if (kittyname.equals("Plan 1")){
        System.out.println(MAROON_BG+BLACK + "- Soup/Drink");
        System.out.println(MAROON_BG+BLACK + "- Starter");
        System.out.println(MAROON_BG+ BLACK + "- Snack");
        System.out.println(MAROON_BG+ BLACK + "- Sweet Dish");
        System.out.println(MAROON_BG+ BLACK + "- Tea or Cofee");
         
}
    if (kittyname.equals("Plan 2")){
        System.out.println(MAROON_BG+ BLACK + "- Soup/Drink");
        System.out.println(MAROON_BG+ BLACK +  "- Starter");
        System.out.println(MAROON_BG+ BLACK +  "- 2. Snack");
        System.out.println(MAROON_BG+  BLACK + "- Sweet Dish");
        System.out.println(MAROON_BG+ BLACK + "- Tea or Cofee");

         
}
    if (kittyname.equals("Plan 3")){
        System.out.println(MAROON_BG+  BLACK + "- Soup/Drink");
        System.out.println(MAROON_BG+ BLACK + "- Paneer Starter");
        System.out.println(MAROON_BG+ BLACK + "- 2 Snack");
        System.out.println(MAROON_BG+ BLACK + "- Sweet Dish");
        System.out.println(MAROON_BG+ BLACK + "- Tea or Cofee");
...
if (thaliName.equals("Thali 1\n")){
        System.out.println(MAROON_BG+BLACK + "- Soup/Drink");
        System.out.println(MAROON_BG+BLACK + "- 2 - vegetable dish ");
        System.out.println(MAROON_BG+ BLACK + "-  dal ");
        System.out.println(MAROON_BG+ BLACK + "- Rice");
        System.out.println(MAROON_BG+ BLACK + "- roti");
         System.out.println(MAROON_BG+ BLACK + "- Sweet Dish ");
        System.out.println(MAROON_BG+ BLACK + "-pickle, salad, Papad ");
         
}
    if (thaliName.equals("Thali 2\n")){
                System.out.println(MAROON_BG+BLACK + "- Soup/Drink");
                System.out.println(MAROON_BG+BLACK + "- Starter");
                System.out.println(MAROON_BG+BLACK + "- Paneer dish");
                System.out.println(MAROON_BG+BLACK + "- 2-vegetable dish ");
                System.out.println(MAROON_BG+ BLACK + "-  dal ");
                System.out.println(MAROON_BG+ BLACK + "- Rice");
                System.out.println(MAROON_BG+ BLACK + "- roti");
    ...
    if (thaliName.equals("Thali 3\n")){
        System.out.println(MAROON_BG+  BLACK + "- Soup/Drink");
        System.out.println(MAROON_BG+  BLACK + "- Starter");
        System.out.println(MAROON_BG+  BLACK + "- Paneer Dish ");
        System.out.println(MAROON_BG+  BLACK + "- 2-vegetable dish ");
        System.out.println(MAROON_BG+  BLACK + "- Curd dish");
        System.out.println(MAROON_BG+  BLACK + "- Daal ");
        System.out.println(MAROON_BG+  BLACK + "- Rice ");
        System.out.println(MAROON_BG+  BLACK + "- Sweet Dish");
     //   System.out.println(MAROON_BG+  BLACK + "- Tea or Cofee");
        System.out.println(MAROON_BG+  BLACK + "-pickle, salad, Papad ");
 ...
 if (thaliName.equals("Thali 4\n")){
        System.out.println(MAROON_BG+  BLACK + "- Soup/Drink");
        System.out.println(MAROON_BG+  BLACK + "- 2 -Starter");
        System.out.println(MAROON_BG+  BLACK + "- 1-Paneer Dish ");
        System.out.println(MAROON_BG+  BLACK + "- 2-vegetable dish ");
        System.out.println(MAROON_BG+  BLACK + "- Curd Dish ");
        System.out.println(MAROON_BG+  BLACK + "- Daal");
        System.out.println(MAROON_BG+  BLACK + "- Rice ");
 ...
 if (thaliName.equals("Thali 5\n")){
        System.out.println(MAROON_BG+  BLACK + "- Soup/Drink");
        System.out.println(MAROON_BG+  BLACK + "- 2 -Starter");
        System.out.println(MAROON_BG+  BLACK + "- 1-Paneer starter ");
        System.out.println(MAROON_BG+  BLACK + "- 1-Pasta ");
        System.out.println(MAROON_BG+  BLACK + "- 1-Paneer Dish ");
        System.out.println(MAROON_BG+  BLACK + "- 2-vegetable dish ");
        System.out.println(MAROON_BG+  BLACK + "- Curd Dish ");
        System.out.println(MAROON_BG+  BLACK + "- Daal");
        System.out.println(MAROON_BG+  BLACK + "- Rice ");
        System.out.println(MAROON_BG+  BLACK + "- Sweet Dish");
        System.out.println(MAROON_BG+  BLACK + "- 1-icecream ");
        System.out.println(MAROON_BG+  BLACK + "-pickle, salad, Papad ");
      
            
}
 if (thaliName.equals("Thali 6\n")){
        System.out.println(MAROON_BG+  BLACK + "- 3-Soup/Drink");
        System.out.println(MAROON_BG+  BLACK + "- 3 -Starter");
        System.out.println(MAROON_BG+  BLACK + "- 1-Paneer starter ");
        System.out.println(MAROON_BG+  BLACK + "- 1-Chinese ");
        System.out.println(MAROON_BG+  BLACK + "- 1-Paneer Dish ");
        System.out.println(MAROON_BG+  BLACK + "- 2-vegetable dish ");
        System.out.println(MAROON_BG+  BLACK + "- Curd Dish ");
        System.out.println(MAROON_BG+  BLACK + "- Daal");
        System.out.println(MAROON_BG+  BLACK + "- Roti");
        System.out.println(MAROON_BG+  BLACK + "- Rice ");
        System.out.println(MAROON_BG+  BLACK + "- 2-Sweet Dish");
        System.out.println(MAROON_BG+  BLACK + "- 1-icecream ");
        System.out.println(MAROON_BG+  BLACK + "-pickle, salad, Papad ");
...
*/
    ...
    public static String chooseRoti(Scanner sc) {
        ...
        int ch = getIntInRange(sc, "Enter choice (1-4): ", 1, 6);
...
public static String choosecoffeechai(Scanner sc) {
        System.out.println(MAROON_BG + WHITE + "Choose Cofee or chai :" + RESET);
        System.out.println(PITCH_BG + BLACK + "1. Cofee \n 2. Chai   . " + RESET);
        int ch = getIntInRange(sc, "Enter choice (1 or 2): ", 1,2 );
        switch (ch) {
                 case 1:
                 return "Cofee";
...
public static String chooseicecream(Scanner sc) {
        System.out.println(MAROON_BG + WHITE + "Choose Cofee or chai :" + RESET);
        System.out.println(PITCH_BG + BLACK + "1. Vanilla  \n 2.  Butter Scotch. " + RESET);
        int ch = getIntInRange(sc, "Enter choice (1 or 2): ", 1,2 );
        switch (ch) {
                 case 1:
                 return "Vanilla";
...
public static String choosesweet(Scanner sc) {
        System.out.println(MAROON_BG + WHITE + "Choose Sweet dish:" + RESET);
        System.out.println(PITCH_BG + BLACK + "1. Gulab Jamun \n 2. Gajar ka halwa  \n 3. Moong ka halwa  \n 4. Shree khand  \n 5. Aam khand  \n 6. Sitaphal Basundi  " + RESET);
        int ch = getIntInRange(sc, "Enter choice (1-6): ", 1, 6);
        switch (ch) {
                 case 1:
                 return "Gulab jamun ";
                 ...
                 case 3:
                 return "Moong ka halwa ";
                 case 4:
                 return "Shree khand ";
                 case 5:
                 return "Aam Khand ";
                 case 6:
                 return "Sitaphal basundi  ";
