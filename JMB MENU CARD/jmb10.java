...
public class jmb10{
    ...
    public static void main(String[] args) {
        ...
        while (ordering) {
            ...
            if (mainChoice == 1) {
                ...
                switch (bch) {
                    ...
                    case 3: breakfastItem = "Heavy Snacks + Tea/Coffee"; breakfastPrice = 180; break;
                }
                ...
                switch (sch) {
                    case 1: snackItem = "Samosa"; snackPrice = 30; break;
                    case 2: snackItem = "Fries"; snackPrice = 120; break;
                    case 3: snackItem = "Kachori"; snackPrice = 40; break;
                    case 4: snackItem = "Khaman"; snackPrice = 100; break;
                }
        ...
        // --- Bill Generation with updated logic ---
        double gstRate = 0;
        if (thaliOrdered) {
            gstRate = 0.18; 
        } else if (breakfastOrdered || snacksOrdered) {
            gstRate = 0.05; 
        }
