...
import java.text.ParseException;
 ...
 class Jmb23281 {
    ...
    public static String chooseRice(Scanner sc) {
        ...
        int ch = getIntInRange(sc, "Enter choice (1-3): ", 1, 3);
        switch (ch) {
            case 1: return "Steamed Rice";
            case 2: return "Jeera Rice";
    ...
    public static String[] chooseDessert(Scanner sc) {
        ...
        switch (ch) {
            case 1:
                ...
                break;
            case 2: type = "Gulab Jamun"; variant = "Regular"; break;
            default: type = "Cake"; variant = "Slice"; break;
        }
    ...
    public static String choosesnack(Scanner sc, int num) {
        ...
        int ch = getIntInRange(sc, "Enter choice (1-3): ", 1, 3);
        switch (ch) {
            case 1: return "Kachori";
            case 2: return "Samosa";
            default: return "Poha";
        }
    }
}
